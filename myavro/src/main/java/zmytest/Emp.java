...
public class Emp extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Emp\",\"namespace\":\"zmytest\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"salary\",\"type\":\"int\"},{\"name\":\"age\",\"type\":\"int\"},{\"name\":\"address\",\"type\":\"string\"}]}");
  ...
  public static Builder newBuilder() {
    return new zmytest.Emp.Builder();
  }
   ...
   * @return A new Emp RecordBuilder
   */
  public static zmytest.Emp.Builder newBuilder(zmytest.Emp.Builder other) {
    return new zmytest.Emp.Builder(other);
  }
   ...
   * @return A new Emp RecordBuilder
   */
  public static zmytest.Emp.Builder newBuilder(zmytest.Emp other) {
    return new zmytest.Emp.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Emp>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(zmytest.Emp.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(zmytest.Emp other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public zmytest.Emp.Builder setName(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public zmytest.Emp.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public zmytest.Emp.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public zmytest.Emp.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public zmytest.Emp.Builder setSalary(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public zmytest.Emp.Builder clearSalary() {
    ...
    /**
      ...
      * @return This builder.
      */
    public zmytest.Emp.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public zmytest.Emp.Builder clearAge() {
    ...
    /**
      ...
      * @return This builder.
      */
    public zmytest.Emp.Builder setAddress(CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public zmytest.Emp.Builder clearAddress() {
      address = null;
